...
public interface StatelessRuleService extends Serializable {
	 ...
	 */
	List executeRules(String ruleSource, Map executionSetProperties, Map sessionProperties, List objects);
	 ...
	 * @throws RuleRuntimeException
	 */
	List executeRules(InputStream ruleSource, Map executionSetProperties, Map sessionProperties, List objects);
	 ...
	 * @throws RuleRuntimeException
	 */
	List executeRules(Reader ruleSource, Map executionSetProperties, Map sessionProperties, List objects);
	 ...
	 * @throws RuleRuntimeException
	 */
	List executeRules(Object ruleSource, Map executionSetProperties, Map sessionProperties, List objects);
